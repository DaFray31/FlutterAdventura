  ...
  Future<void> addToComment() async {
    try {
      ...
      if (newComment.isNotEmpty) {
        final response = await EndScreen.supabase
            .from('commentaires')
            .insert({'aventure_id': widget.adventureId, 'commentaires': newComment, 'note': selectedStarCount});
            ...
            Row(
              ...
              children: List.generate(
                5,
                  ...
                  onPressed: () {
                    setState(() {
                      ...
                      if (selectedStarCount == index + 1) {
                        selectedStarCount = 0; // Deselect the star if it's already selected
                      } else {
                  ...
                  icon: Icon(
                    Icons.star,
                    color: index < selectedStarCount ? Colors.amber : Colors.grey,
                    size: 30,
                  ),
                ),
              ),
